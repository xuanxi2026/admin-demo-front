      ...
      <div class="login-right">
        <div class="login-card">
          ...
          <el-form ref="form" class="login-form" label-position="left" :model="form" :rules="rules">
            ...
            <el-form-item class="form-item" prop="googleCode">
              <div class="input-wrapper">
                <div class="input-icon">
                  <i class="el-icon-key"></i>
                </div>
                <el-input v-model.trim="form.googleCode" class="custom-input" maxlength="6" placeholder="请输入谷歌验证码" tabindex="3" />
              </div>
            </el-form-item>
  ...
  .login-container {
    ...
    .login-background {
      ...
      .background-overlay {
        ...
        right: 0;
        bottom: 0;
        background: linear-gradient(135deg, rgba(34, 87, 188, 0.7), rgba(19, 48, 113, 0.75));
