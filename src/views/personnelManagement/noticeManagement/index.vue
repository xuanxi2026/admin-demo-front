<template>
  <div class="noticeManagement-container">
    ...
    <vab-query-form>
      ...
      <vab-query-form-right-panel :span="12">
        <el-form :inline="true" :model="queryForm" @submit.native.prevent>
          <el-form-item>
            <el-select v-model="queryForm.level" clearable placeholder="公告级别">
              <el-option label="普通" value="normal" />
              <el-option label="重要" value="important" />
            </el-select>
          </el-form-item>
          <el-form-item>
            <el-input v-model.trim="queryForm.keyword" clearable placeholder="标题/内容/发布人" />
          </el-form-item>
          <el-form-item>
    ...
    <el-table v-loading="listLoading" :data="list" :element-loading-text="elementLoadingText" @selection-change="setSelectRows">
      ...
      <el-table-column label="修改时间" prop="datatime" width="180" />
...
<script>
  ...
  import Edit from './components/NoticeManagementEdit'
  ...
  export default {
    ...
    data() {
      return {
        ...
        queryForm: { pageNo: 1, pageSize: 10, level: '', keyword: '' },
        timeOutID: null,
      }
    },
    created() {
    ...
    methods: {
      ...
      async fetchData() {
        ...
        try {
          ...
          this.$baseMessage('通知公告加载失败，请检查后端接口是否已启动', 'error')
        } finally {
